...
export default async function MemoriesDetails({ params }: MemoriesDetaisProps) {
  ...
  return (
    <div className="flex flex-col p-8">
      ...
      <time className="mb-2 text-sm text-gray-100">
        {dayjs(memoryDetails.createdAt).format('D[ de ]MMMM[, ]YYYY')}
      </time>
      <Image
